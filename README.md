...
"Deliver value daily" encourages you to understand the real problems so you solve them appropriately. While it can certainly help with reporting progress, it needs autonomy, trust, and a psychologically safe environment. Things like working in sprints, estimating, and regularly answering "What did you do yesterday?" should only be done if your team finds them useful, and never be dictated from above.
