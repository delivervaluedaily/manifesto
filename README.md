...
In other words, having a value chain and delivering value to the next step is completely acceptable if value moves through the chain at least daily, and allows for flexibility within subsequent steps.
